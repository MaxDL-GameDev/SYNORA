...
{
    public sealed class CreatureRestoreTimerTests
    {
        [Test]
        public void NotComplete_BeforeReachingDuration()
        {
            var t = new CreatureRestoreTimer(1.25f);
            t.Tick(0.5f);
        ...
        {
            var t = new CreatureRestoreTimer(1.0f);
            t.Tick(1.0f);
        ...
        {
            var t = new CreatureRestoreTimer(0f);
        ...
        {
            var t = new CreatureRestoreTimer(-3f);
            Assert.IsTrue(t.IsComplete);
        }
        ...
        {
            var a = new CreatureRestoreTimer(1.0f);
            var b = new CreatureRestoreTimer(1.0f);
        ...
        {
            Assert.AreEqual(1.25f, CreatureRestoreTimer.Normalize(1.25f));
            Assert.AreEqual(0f, CreatureRestoreTimer.Normalize(0f));
            Assert.AreEqual(0f, CreatureRestoreTimer.Normalize(-2f));
        }
    }
}
